...
export default function Dashboard({ token, onLogout }) {
  ...
  const getEventStartDate = (event) => new Date(event.startAt || event.date || event.startDate || Date.now());
  ...
  const featuredEvent =
    upcomingEvents.length > 0
      ? upcomingEvents.reduce((soonest, ev) =>
          getEventStartDate(ev) < getEventStartDate(soonest) ? ev : soonest
        )
      : null;
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center text-purple-200">
                  ...
                  <span className="text-lg">
                    {formatDateTime(featuredEvent.startAt || featuredEvent.date, { includeTimeZone: true, fallback: "" })}
                  </span>
                </div>
              </div>
              <div className="ml-6">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center text-gray-500 mb-2">
                      ...
                      <span className="text-sm">
                        {formatDateTime(ev.startAt || ev.date, { includeTimeZone: true, fallback: "" })}
                      </span>
                    </div>
              ...
              {recommendations.map((ev, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 mb-4">
                    {formatDateTime(ev.startAt || ev.date, { fallback: "" })}
                  </p>
                  <button 
