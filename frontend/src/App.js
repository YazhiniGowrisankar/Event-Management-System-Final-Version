      ...
      <Layout role={role} token={token} onLogout={handleLogout} user={user}>
        <Routes>
            ...
            <Route
              ...
              element={
                token ? (
                  <UserProfile token={token} user={user} onUpdateUser={(updatedUser) => setUser(updatedUser)} />
                ) : (
                  <Navigate to="/login" />
                )
              }
            ...
            <Route
              ...
              element={
                token ? (
                  <EventCalendar token={token} role={role} />
                ) : (
                  <Navigate to="/login" />
                )
              }
